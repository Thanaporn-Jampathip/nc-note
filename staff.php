    ...
    <div class="d-flex">
        ...
        <div class="container-fluid m-2 p-4 border rounded-3"style="height: auto;">
            ...
            <div class="d-flex">
                ...
                <!-- BUTTON ADD -->
                <?php if($localUser) { ?>
                    <button class="btn btn-success ms-auto align-self-start" data-bs-toggle="modal" data-bs-target="#addStaff" type="button">เพิ่ม</button>
                <?php } ?>
                <!-- MODAL ADD STAFF -->
                    ...
                    <tr>
                        ...
                        <?php if(!$localUser && $row['id'] == $userid){ ?>
                            ...
                            <td>
                                ...
                                <button class="btn btn-warning btn-sm w-100" type="button" data-bs-toggle="modal" data-bs-target="#editUserLocal<?php echo $row['id']; ?>">แก้ไข</button>
                                        ...
                                        <div class="modal-content">
                                            <form action="" method="post">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="mb-3">
                                                        <label>ชื่อ-สกุล</label>
                                                        <input type="text" name="nameEditUserLocal" class="form-control" value="<?php echo $row['username']; ?>" required>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label>รหัสผ่าน</label>
                                                        <input type="password" name="passwordEditUserLocal" class="form-control" value="<?php echo $row['password'] ?>" required>
                                                    </div>
                                                        <button type="submit" name="editUserLocal" class="btn btn-warning w-100">แก้ไขข้อมูล</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
                        ...
                        <?php if($localUser){ ?>
                            ...
                            <td class="d-flex">
                                <!-- BUTTON EDIT -->
                                <button class="btn btn-warning btn-sm w-100 me-2" type="button" data-bs-toggle="modal" data-bs-target="#editStaffModal<?php echo $row['id']; ?>">แก้ไข</button>
                                <!-- MODAL EDIT -->
                                ...
                                <?php if ($localUser && $row['username'] != 'หัวหน้างานหลักสูตร' && $row['username'] != 'รองฝ่ายวิชาการ') { ?>
                                    <button class="btn btn-danger btn-sm w-100" type="submit" name="delete" value="<?php echo $row['id'] ?>">ลบ</button>
                                <?php } ?>
                            </td>
                        <?php } ?>
                    </tr>
