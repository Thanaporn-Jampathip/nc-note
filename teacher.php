                            ...
                            <form action="" method="post" id="formInsertTeacher">
                                ...
                                <div class="modal-body">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="nameIn" class="form-control" id="nameIn"
                                            placeholder="กรอกชื่อจริง" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="">นามสกุล</label>
                                        <input type="text" name="lastnameIn" class="form-control" id="lastnameIn"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="password" name="passwordIn" class="form-control" id="passwordIn"
                                            placeholder="กรอกรหัสผ่าน" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="">รหัสผ่านยืนยันเข้าสอน</label>
                                        <input type="password" name="passwordV_IN" class="form-control"
                                            id="passwordV_IN" placeholder="กรอกรหัสผ่าน" required>
                                    </div>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <form action="./backend/editTeacher.php" method="post" id="formEditTeacher">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <input type="hidden" value="<?php echo $row['id'] ?>" id="editTeacherID"
                                                    name="teacherID">
                                                <div class="mb-3">
                                                    <label for="">ชื่อจริง</label>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="lastnameEdit" class="form-control"
                                                        id="lastnameEdit" value="<?php echo $row['lastname'] ?>" required>
                                                </div>
                                                <div class="mb-3">
                                                    <label for="">สาขา</label>
                                                    <select name="branch" id="selectBranchEdit" class="form-control">
                                                        <option value="1 " <?php if ($row['branch_id'] == '1')
                                                            echo 'selected'; ?>>การบัญชี</option>
                                                        <option value="2 " <?php if ($row['branch_id'] == '2')
                                                            echo 'selected'; ?>>การตลาด</option>
                                                        <option value="3 " <?php if ($row['branch_id'] == '3')
                                                            echo 'selected'; ?>>การจัดการสำนักงาน</option>
                                                        <option value="4 " <?php if ($row['branch_id'] == '4')
                                                            echo 'selected'; ?>>โลจิสติกส์</option>
                                                        <option value="5 " <?php if ($row['branch_id'] == '5')
                                                            echo 'selected'; ?>>เทคโนโลยีธูรกิจดิจิทัล</option>
                                                        <option value="6 " <?php if ($row['branch_id'] == '6')
                                                            echo 'selected'; ?>>ธุรกิจค้าปลีก</option>
                                                        <option value="7 " <?php if ($row['branch_id'] == '7')
                                                            echo 'selected'; ?>>เทคโนโลยีสารสนเทศ</option>
                                                        <option value="8 " <?php if ($row['branch_id'] == '8')
                                                            echo 'selected'; ?>>ภาษาต่างประเทศ</option>
                                                        <option value="9 " <?php if ($row['branch_id'] == '9')
                                                            echo 'selected'; ?>>การโรงแรม</option>
                                                        <option value="10 " <?php if ($row['branch_id'] == '10')
                                                            echo 'selected'; ?>>อาหารและโภชนาการ</option>
                                                        <option value="11 " <?php if ($row['branch_id'] == '11')
                                                            echo 'selected'; ?>>คหกรรม</option>
                                                        <option value="12 " <?php if ($row['branch_id'] == '12')
                                                            echo 'selected'; ?>>แฟชั่นและสิ่งทอ</option>
                                                        <option value="13 " <?php if ($row['branch_id'] == '13')
                                                            echo 'selected'; ?>>การออกแบบ</option>
                                                        <option value="14 " <?php if ($row['branch_id'] == '14')
                                                            echo 'selected'; ?>>ดิจิทัลกราฟิก</option>
                                                    </select>
                                                </div>
                                                <div class="mb-3">
                                                    <label for="">รหัสผ่านบัญชี</label>
                                                    <input type="password" name="passwordEdit" class="form-control"
                                                        id="passwordEdit" value="<?php echo $row['password'] ?>" required>
                                                </div>
                                                <div class="mb-3">
                                                    <label for="">รหัสผ่านยืนยันเข้าสอน</label>
                                                    <input type="password" name="passwordV_Edit" class="form-control"
                                                        id="passwordV_Edit" value="<?php echo $row['password_match'] ?>"
                                                        required>
                                                </div>
