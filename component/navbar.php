...
<body>
    <nav class="navbar navbar-expand w-100 bg-primary px-2">
            ...
            <div class="collapse navbar-collapse" id="navbarNavDarkDropdown">
                <ul class="navbar-nav">
                    <li class="nav-item dropdown">
                        ...
                        <button class="username btn dropdown-toggle text-white fs-6" data-bs-toggle="dropdown" aria-expanded="false"><?php echo $rowNAV['username'] ?></button>
                        ...
                        <ul class="dropdown-menu dropdown-menu-light dropdown-menu-end px-2">
                            ...
                            <?php if($usertype === 'staff'){ ?>
                                <li class="text-center">---- เจ้าหน้าที่ ----</li><hr>
                            <?php }elseif ($usertype === 'user'){ ?>
                                <li class="text-center">---- ผู้ใช้งาน ----</li><hr>
                            <?php } ?>
                            <form action="./backend/logout.php" method="post">
                                <input class="btn btn-danger w-100 btn-sm" type="submit" name="logout" value="ออกจากระบบ"></input>
                            </form>
                        </ul>
                    </li>
                </ul>
