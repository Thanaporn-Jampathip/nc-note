        ...
        <form action="" method="post" class="d-flex justify-content-center">
            <div class="card mt-4 shadow">
                ...
                <div class="card-body px-5 py-3">
                    ...
                    <div class="mb-4">
                        <label for="" class="mb-2">ชื่อผู้ใช้</label>
                        <input type="text" name="username" class="form-control"  required>
                    </div>

                    <div class="mb-4">
                        <label for="" class="mb-2">รหัสผ่าน</label>
                        <input type="password" name="password" class="form-control" required>
                    </div>

                    <input class="btn btn-primary w-100 my-2" type="submit" name="login_user" value="เข้าสู่ระบบ"></input><br>
                    
                    <a href="login_staff.php">สำหรับเจ้าหน้าที่ / ผู้บริหาร</a><br>
                    <a href="เอกสารคู่มือการใช้เว็บบันทึกการเรียนการสอน(นักเรียน).pdf">คู่มือการใช้งานเว็บ (สำหรับนักเรียน)</a>
                </div>
            </div>
        </form>
    </div>
